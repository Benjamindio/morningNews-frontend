...
function Header() {
	...
	const handleRegister = () => {
		fetch('https://morning-news-backend-benjamindio.vercel.app/users/signup', {
			method: 'POST',
	...
	const handleConnection = () => {
		...
		fetch('https://morning-news-backend-benjamindio.vercel.app/users/signin', {
			method: 'POST',
			headers: { 'Content-Type': 'application/json' },
	...
	let hiddenArticle = <FontAwesomeIcon onClick={() => handleShowArticleClick()} icon={faEye}  className={styles.showIcon} />
	let userSection;
	if (user.token) {
		userSection = (
